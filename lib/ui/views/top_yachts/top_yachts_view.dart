...
import 'top_yachts_viewmodel.dart';

class TopYachtsView extends StackedView<TopYachtsViewModel> {
  const TopYachtsView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    TopYachtsViewModel viewModel,
    Widget? child,
  ) {
    return Scaffold(
  ...
  @override
  TopYachtsViewModel viewModelBuilder(BuildContext context) =>
      TopYachtsViewModel();
  @override
  void onViewModelReady(TopYachtsViewModel viewModel) {
